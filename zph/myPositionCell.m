...
- (void)setModel:(NSMutableDictionary *)model{
    ...
    [address setTitle:[model objectForKey:@"areas"]?[model objectForKey:@"areas"]:@"" forState:UIControlStateNormal];
    [Degree setTitle:[[model objectForKey:@"educations"] isEqualToString:@""]?@"不限":[model objectForKey:@"educations"] forState:UIControlStateNormal];
